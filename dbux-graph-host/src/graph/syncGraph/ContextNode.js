  ...
  public = {
    selectFirstTrace() {
      ...
      if (firstTrace) {
        ...
        this.componentManager.externals.emitCallGraphTraceAction(UserActionType.CallGraphTrace, firstTrace);
      }
      else {
    ...
    selectCallTrace() {
      ...
      if (callTrace) {
        ...
        this.componentManager.externals.emitCallGraphTraceAction(UserActionType.CallGraphCallTrace, callTrace);
      }
    },
