...
1. You did not instrument the application. Make sure to use one of the four methods of [Running a JavaScript Application w/ Dbux Enabled](../using-dbux/overview#enabling-dbux).
