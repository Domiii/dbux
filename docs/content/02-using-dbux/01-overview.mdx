...
First, run an application [with Dbux enabled](#enabling-dbux). Then make sure that the new application shows up in the [Application View](#application-view).

Once the application shows up, you have several options to start your analysis:
