...
const { sleepImmediate, randomInt } = require('./asyncUtil');
...
exports.produce = async function produce() {
  ...
  await sleepImmediate((ProducerTime - ProducerTimeVar) + randomInt(ProducerTimeVar * 2 + 1));
...
exports.consume = async function consume() {
  ...
  await sleepImmediate((ConsumerTime - ConsumerTimeVar) + randomInt(2 * ConsumerTimeVar + 1));
