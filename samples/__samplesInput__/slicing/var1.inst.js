...
try {
  ...
  _tw((a = _te(1, (_t8_ = _tid(8)), 0, null)), (_t9_ = _tid(9)), _t3_, 0, [
    _t8_,
  ]);
  _tw((b = _te(2, (_t10_ = _tid(10)), 0, null)), (_t11_ = _tid(11)), _t5_, 0, [
    _t10_,
  ]);

  _te(
    _te(a, (_t12_ = _tid(12)), _t3_, null) +
      _te(b, (_t13_ = _tid(13)), _t5_, null),
    (_t14_ = _tid(14)),
    0,
    [_t12_, _t13_]
  );
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
