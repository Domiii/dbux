...
:::tip
The *synchronous* [call graph](../02-using-dbux/08-call-graph.mdx) lists all CGRs on a linear timeline.
The nodes of the *asynchronous* [call graph](../02-using-dbux/08-call-graph.mdx) only comprises call graph roots.
:::
