...
There are buttons to render the value in a new VSCode window, as well as going to the value's origin trace (see [Data Flow](./50-data-flow.mdx) for more info).
