...
You can find configuration options for the different tools in the ["Tools and Configuration" chapter](../tools-and-configuration/00-architecture-overview.mdx).
