...
In order to analyze an application, it first needs to be [recorded](./dbux-features/02-enable-dbux.mdx) and sub-sequently show up in [the application view](./dbux-features/06-applications.mdx).
