...
When working through [Dbux Practice exercises](./dbux-practice/01-overview.mdx), more tools might be required for each project. As of Jan. 2022, it at least requires `git` to be installed:
