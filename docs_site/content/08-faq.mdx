...
If you are certain that a file executed in a [Dbux-enabled application](./runtime-analysis/02-enable-dbux.mdx), make sure your [configuration is setup to include](./guides/01-which-files-are-traced.mdx) the file in that specific package or path.
