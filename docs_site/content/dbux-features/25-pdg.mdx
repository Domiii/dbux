...
<Img screen src="pdg-commands.png" />
...
## Show PDG of any function {#any-pdg}

<Img screen src="pdg-commands.png" />

1. [Run Application with Dbux Enabled](./02-enable-dbux.mdx)
2. [Select a trace of any function](./06-select-trace.mdx)
3. Use the `Dbux: Open PDG for Selected Function` [command](./tools-and-configuration/01-dbux-code.mdx#commands) (see screenshot above)
