...
## Why do we need an Asynchronous Call Graph (ACG)?
...
## How does the Asynchronous Call Graph (ACG) work?
...
:::tip
For more in-depth technical information, consult our ICSE-SEIP paper: [An Asynchronous Call Graph for JavaScript (ACM, 2022)](https://ieeexplore.ieee.org/document/9794057).
:::
