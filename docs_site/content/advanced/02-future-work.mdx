...
NOTE: Most of these features still work fine, but some related information is not available and data flow analysis is incomplete.
...
TODO: merge the following with all of the above
