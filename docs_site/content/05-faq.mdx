...
1. You did not instrument the application. Make sure to use one of the four methods of [Running a JavaScript Application w/ Dbux Enabled](./using-dbux).
...
Dbux offers [several commands](./04-tools-and-configuration/01-dbux-code.mdx#commands). This is how commands work in VSCode:
...
:::tip
All buttons in the Dbux VSCode Extension have corresponding [commands](../tools-and-configuration/dbux-code#commands).
:::
