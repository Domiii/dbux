...
In order to analyze an application, it first needs to be [recorded](./02-using-dbux/02-enable-dbux.mdx) and sub-sequently show up in [the application view](./02-using-dbux/06-applications.mdx).
