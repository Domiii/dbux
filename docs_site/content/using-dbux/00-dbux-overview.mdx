...
2. Then use the Dbux VSCode Extension for [runtime analysis](./00-dbux-overview.mdx#runtime-analysis), as explained below:

All recorded application should show up in the [Application View](./using-dbux/06-applications.mdx).
...
* Use the [Application View](./using-dbux/applications) to overview all recorded applications.
  * Here you can also toggle applications individually and go to the ***entry point***.
